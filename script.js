document.addEventListener('DOMContentLoaded', function() {
    ...
    const START_DATE = new Date(new Date().getFullYear(), 2, 5); // June 5th (months are 0-based)
    const END_DATE = new Date(new Date().getFullYear(), 8, 2);  // September 3rd
    ...
    // Close modal when clicking outside the result box
